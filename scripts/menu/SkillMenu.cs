...
public partial class SkillMenu : Menu
{
    ...
    {
        CursorPositions = [new Vector2I(170, 435), new Vector2I(340, 435), new Vector2I(170, 457), new Vector2I(340, 457)];
    }
    ...
    public void Populate(Actor actor)
    {
        ...
        CursorIndex = 0;
        CursorPositions = CursorPositions.GetRange(0, Skills.Count);
        UpdateCursor();
        ShowSkillInfo();
    }
