...
internal sealed class Kel : PartyMember
{
    ...
    public override int[] DEFTree => new[] { 4, 5, 5, 6, 7, 8, 9, 9, 10, 11, 12, 12, 13, 15, 16, 18, 19, 20, 22, 23, 24, 26, 27, 28, 29, 30, 32, 34, 36, 37, 39, 41, 42, 42, 43, 44, 46, 47, 48, 50, 52, 54, 56, 58, 59, 62, 64, 66, 68, 70 };
    ...
    public override string[] EquippableWeapons => ["Rubber Ball", "Meteor Ball", "Blood Orange", "Jack", "Beach Ball", "Coconut", "Globe", "Chicken Ball", "Snowball", "Basketball"];
}